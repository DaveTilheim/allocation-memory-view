...
typedef struct __AMV_List_t __AMV_List;
typedef struct
{
	void *mem;
...
AMVGlobalTools.memBlocks__AMV_List=AMVGlobalTools.add_cpylastAMV(AMVGlobalTools.memBlocks__AMV_List, sizeof(AMVMemBlock_t), &AMVGlobalTools.SatckmemTemp),\
