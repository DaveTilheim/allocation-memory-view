...
#endif
#ifdef __linux__
#define _VERSION "\033[97muntested AMVC linux version (0.1.0)\033[0m"
#endif
...
void setAMVCFiles(char *,__AMV_List*, const char*, char [2], int);
void compileAMVCFiles(const char *,__AMV_List*, const char*, const char*, const char*);
void ls_str(char *);
